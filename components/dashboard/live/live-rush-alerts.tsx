...
export function LiveRushAlerts({ rushAlerts }: LiveRushAlertsProps) {
  ...
  return (
    <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-4 sm:p-5 shadow-xs transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {rushAlerts.map((alert) => {
          ...
          return (
            <div
              key={alert.id}
              className="flex flex-col justify-between rounded-lg border border-border/80 bg-card p-3.5 shadow-2xs hover:border-destructive/40 transition-colors"
            >
              <div>
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <Badge
                    variant="outline"
                    className={`text-[10px] px-1.5 py-0 font-medium ${categoryMeta.color}`}
                  >
              ...
              <div className="flex items-center justify-between gap-2 pt-3 mt-2 border-t border-border/50">
                ...
                <Button
                  ...
                  size="sm"
                  variant="outline"
                  className="h-7 text-xs px-2.5 font-medium border-destructive/30 hover:bg-destructive/10 text-destructive"
                >
